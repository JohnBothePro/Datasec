 ...
 * notes/links/history/attachments ONLY if explicitly requested — never auto-chain.
...
export async function ticketBriefing(
  ...
  if (include.size === 0) {
    warnings.push(
      "LIGHT: nur Ticket-Kern. notes/links/history/attachments nur bei explizitem include — kein Auto-Chain."
    );
  }
